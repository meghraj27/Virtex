...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        ...
                        {
                            files: [
                                'js/plugins/highstock/highstock.js'
                            ]
                        },
                        {
                            name: 'angular-peity',
                        ...
                        },
                        {
                            ...
                            name: 'angularMoment',
                            files: [
                                'js/plugins/momentjs/moment.min.js',
                                'js/plugins/momentjs/angular-moment.min.js'
                            ]
                        }
                    ]);
                }
        ...
        .state('trades.trade_book', {
            url: "/trade-book",
            templateUrl: "views/trade_book.html",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('trades.order_book', {
            url: "/order-book",
            templateUrl: "views/trade_order_book.html",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
