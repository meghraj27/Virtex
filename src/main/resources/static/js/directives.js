    ...
    return {
        link: function (scope, element) {
            var listener = function (event, toState, toParams, fromState, fromParams) {
                ...
                var title = 'BITEX | Exchange for Bitcoin trading';
                // Create your own title pattern
                if (toState.data && toState.data.pageTitle) title = 'BITEX | ' + toState.data.pageTitle;
                $timeout(function () {
                    element.text(title);
                });
            };
...
/**
 * tradeBookRowDetail - directive for tradeBook DataTable RowDetail
 */
function tradeBookRowDetail() {
    return {
        restrict: 'A',
        templateUrl: 'views/trade_book_rowdetail_template.html',
        transclude: true,
        link: function (scope, element, attrs) {
...
/**
 * tradeOrderBookRowDetail - directive for tradeOrderBook DataTable RowDetail
 */
function tradeOrderBookRowDetail() {
    return {
        restrict: 'A',
        templateUrl: 'views/trade_order_book_rowdetail_template.html',
        transclude: true,
        link: function (scope, element, attrs) {
